...
function deveMostrarCarta(carta, categoria, precoMaximo) {
    ...
    const correspondeCategoria = !categoria || categoriaCarta.toLowerCase() === categoria.toLowerCase();
    const correspondePreco = !precoMaximo || precoCarta <= parseFloat(precoMaximo);
